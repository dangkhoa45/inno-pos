        ...
        {selectedTab === 0 && (
          ...
          >
            ...
            >
              ...
              >
                Sau khi nhập đầy đủ địa chỉ, bạn có thể lựa chọn hãng vận chuyển
                phù hợp với giá tốt nhất
              </Typography>
        ...
        {selectedTab === 1 && (
          <React.Fragment>
            ...
            >
              <Typography
                variant="body2"
                sx={{ width: '120px', color: 'text.secondary' }}
              >
                Đối tác giao hàng
              </Typography>
              <TextField
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 2 }}>
                <Typography
                  variant="body2"
                  sx={{ width: '120px', color: 'text.secondary', pt: 2 }}
                >
                  Thời gian giao hàng
                </Typography>
                <DateTimePicker
